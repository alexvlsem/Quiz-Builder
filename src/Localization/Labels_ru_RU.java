...
public class Labels_ru_RU extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
            ...
            {"msQuestionCantBeRemoved", "Вопрос не может быть удален\nпотому что у него есть ответы."},
            ...
            {"msAnswerCantBeRemoved", "Ответ не может быть удален\nпотому что он уже используется в выполненных Квизах."},
